    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 ml-2 mb-0">/ {{ __('web/admin/eventday.create_new') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
            ...
            <div class="card-body">
                <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                    <div class="card-body pt-0">
                        <form action="{{ route('admin.eventdays.store') }}" method="POST">
                            @csrf
                            <div class="">
                                <div class="form-group">
                                    <label for="event_date">{{ __('web/admin/eventday.eventday_date') }}</label>
                                    <input type="date" value="{{ old('event_date') }}" name="event_date"
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="movies">
                                        <div class="movie">
                                            <select name="movies[0]" class="form-control">
                                ...
                                <div class="row">
                                    <button type="button" class="btn btn-primary" id="add-movie">{{ __('web/admin/eventday.add_movie') }}</button>
                                </div>
                            </div>
                            <button type="submit" class="btn btn-primary mt-3 mb-0">
                                {{ __('web/admin/movie.create') }}
                            </button>
                        </form>
                    </div>
                </div>
