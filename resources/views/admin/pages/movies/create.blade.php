                            ...
                            <div class="">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description_en" class="form-control" id="description_en" cols="30" rows="3"
                                        placeholder="{{ __('web/admin/movie.description_en_place') }}">{{ old('description_en') }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description_ar" class="form-control" id="description_ar" cols="30" rows="3"
                                        placeholder="{{ __('web/admin/movie.description_ar_place') }}">{{ old('description_ar') }}</textarea>
