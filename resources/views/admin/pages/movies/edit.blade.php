...
@section('contentHeaderActive', 'Update Movie')
@section('content')
    <div class="row">
        <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="price" value="{{ old('price', $movie->price) }}" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type" id="movieType" class="form-control">
                                        ...
                                        @foreach ($types as $type)
                                            <option {{ old('status', $movie->type->value) == $type->value ? 'selected' : '' }}
                                                value="{{ $type->value }}">
                                                {{ $type->lang() }}
                                            </option>
                                        @endforeach
